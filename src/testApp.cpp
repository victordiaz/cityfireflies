...
//settings
 ...
 /**   
  ...
  //  ofLogToFile("logfile3.txt",true) ;
    ...
    myPerfectPixelsRescale.setSize(6, 6, myOfxFBOTextureCenter.getWidth(), myOfxFBOTextureCenter.getHeight());
...
void testApp::draw() { 
	...
	*/ 
    ...
    if (fullscreen) { 
        ...
        myPerfectPixelsRescale.resample( (unsigned char *) myOfxFBOTextureCenter.getPixels() );  //*************** 
